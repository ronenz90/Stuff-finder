...
def main():
    ...
    for product in products:
        ...
        for norm, r in candidates.items():
            ...
            # התראה אוטומטית: כל מילות השם + דף מכירה + לא כתבה + לא מעל התקציב + לא מינימום הזמנה.
            # כל חריגה — לסינון AI בלוח הבקרה.
            if score >= 100 and verdict["is_sale_page"] and not is_newsy and not over_budget and not has_moq:
